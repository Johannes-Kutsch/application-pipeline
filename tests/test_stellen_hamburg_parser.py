...
def test_enrich_empty_description_when_no_jsonld(
    run_log: RunLog, stub: PositionStub
) -> None:
...
def test_enrich_parses_posted_date(run_log: RunLog, stub: PositionStub) -> None:
...
def test_enrich_deadline_none_when_field_absent(
    run_log: RunLog, stub: PositionStub
) -> None:
...
def test_enrich_maps_full_time_employment_type(
    run_log: RunLog, stub: PositionStub
) -> None:
...
def test_enrich_maps_part_time_employment_type(
    run_log: RunLog, stub: PositionStub
) -> None:
...
def test_enrich_employment_type_none_when_absent(
    run_log: RunLog, stub: PositionStub
) -> None:
    get = _make_get([_detail_html()])
    with StellenHamburgParser(
