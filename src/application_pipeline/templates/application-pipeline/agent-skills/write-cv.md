...
- `analysis.md` — neutraler Listing-Summary + „Why apply"-Bullets + `Cover strategy` (ein Lead-Hook mit Supporting/Reserve-Hooks) + Listing-fordert / Hook / Anekdote-Tailoring-Hooks.
