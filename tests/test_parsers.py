...
def test_parser_protocol_works_as_context_manager(parser: _ConcreteParser):
    q = ParserQuery(keyword="python", location=Remote())
    with parser as p:
