...
% Name der Ansprechperson (Vorname Nachname) oder Abteilungsbezeichnung.
% Wenn kein Name bekannt: "Personalabteilung" oder leer lassen.
Frau Dr. Müller

%% SLOT: recipient_line_2
% Straße, Hausnummer, Postleitzahl und Stadt — alles in einer Zeile.
Musterstraße 42, 20095 Hamburg

%% SLOT: opening
% Förmliche Anrede passend zum Empfänger in recipient_line_1.
...
%% SLOT: skills_block
% Kompakte Auflistung technischer Kernkompetenzen in Kategorien (\cvitem).
% Nur Technologien nennen, die wirklich beherrscht werden --- keine Füllwörter.
\cvitem{Sprachen}{Python, SQL, TypeScript, Rust}
\cvitem{Daten}{Apache Kafka, dbt, Airflow, Spark, PostgreSQL}
\cvitem{Cloud \& Infra}{AWS (S3, Glue, Lambda), Docker, Kubernetes, Terraform}
\cvitem{ML}{scikit-learn, \textit{PyTorch} (Grundkenntnisse), MLflow}
